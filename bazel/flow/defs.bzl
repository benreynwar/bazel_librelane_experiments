...
load(":full_flow.bzl",
    _librelane_full_flow = "librelane_full_flow",
    _librelane_hard_macro = "librelane_hard_macro",
)
...
# Convenience macros
librelane_full_flow = _librelane_full_flow
librelane_hard_macro = _librelane_hard_macro
